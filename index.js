...
client.login("OTY3NDA5NjIyMDEwOTcwMTUy.YmP4aw.EtN1yuahEEcl6L8473fNJVCBGA4");
...
client.on("messageReactionAdd", async function (messageReaction, user) {
    ...
    if (messageReaction._emoji.name == "📩") { //Personalizzare l'emoji della reaction
        if (messageReaction.message.channel.id == "967410449291313193") { //Settare canale
            ...
            server.channels.create(user.username, {
                ...
                canale.setParent("967410423072690186") //Settare la categoria
